...
class TextBuffer:
    ...
    def put_char(self, x: int, y: int, char: str, fg: Optional[int] = None, bg: Optional[int] = None):
    ...
    def put_string(self, x: int, y: int, text: str, fg: Optional[int] = None, bg: Optional[int] = None):
    ...
    def put_string_centered(self, y: int, text: str, fg: Optional[int] = None, bg: Optional[int] = None):
